        ...
        return(
            <nav className="navigation">
                <div className="navigation-icon">
                    <div>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="alicorn" role="img"
                ...
                <span className="navigation-title">Habit Tracker</span>
                <span className="navigation-count">{this.props.totalCount}</span>
            </nav>
        )
    }
}
